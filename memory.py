...
# http://www.codeskulptor.org/#user14_8yYQFlTVNv_1.py
...
def draw(canvas):
    ...
    for c in range(len(cards)):
        if cards[c][1] == True:
            canvas.draw_text(str(cards[c][0]), (c*50 + 10, 75), 50, "Blue")
        elif cards[c][1] == False:
            canvas.draw_polygon([(c*50, 0), ((c+1)*50, 0), ((c+1)*50, 100), (c*50, 100)], 1,"black", "Lime")
